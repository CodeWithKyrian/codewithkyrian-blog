<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-cloak x-data="{ darkMode: false }" x-bind:class="{ 'dark': darkMode }"
...
<head>
    ...
    <title>Programming Tutorials and Guides | CodeWithKyrian</title>
...
<body class="bg-zinc-50 dark:bg-zinc-900" x-data="{ sticky: false }">
        ...
        <nav class="relative backdrop-blur border-b border-zinc-200 px-6 lg:px-12 py-2.5 dark:border-zinc-700/60"
            ...
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    {{-- <HamburgerButton open="{sideMenuOpen}" onClick="{toggleSideMenu}"/> --}}
                </div>

                {{-- <div class:hidden={!sideMenuOpen}
                        class="items-center justify-between w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu">
                        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <a href="/" class="block uppercase py-2 pr-4 pl-3 lg:p-0 {navClass('/')}">Home</a>
                            </li>
                            <li>
                                <a href="/about-kyrian"
                                    class="block uppercase py-2 pr-4 pl-3 lg:p-0 {navClass('/about-kyrian')}">About
                                    Me</a>
                            </li>
                        </ul>
                    </div> --}}
            ...
            <section id="intro" class="w-full">
                <div class="max-w-screen-md px-4 py-8 mx-auto text-center">
                    ...
                    <p class="text-zinc-600 sm:text-xl dark:text-zinc-400">Welcome to my coding Wonderland! Join
                        ...
                        learn new things and unleash your inner geek. Let's
                        geek out together😜!</p>
                </div>
            </section>
        </div>
        ...
        <div class="max-w-screen-xl p-4 py-6 mx-auto md:p-8">
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-zinc-500 dark:text-zinc-400">
                    © 2022-2023 <a href="/" class="hover:underline">CodeWithKyrian™</a>. All Rights Reserved.
                </span>
                <ul class="flex justify-center mt-5 space-x-5">
                    <li>
                        <a id="facebook-footer" href="https://web.facebook.com/CodeWithKyrian/"
                    ...
                    <li>
                        <a id="instagram-footer" href="https://www.instagram.com/codewithkyrian/"
                            class="text-zinc-500 hover:text-zinc-900 dark:hover:text-white dark:text-zinc-400">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
                    ...
                    <li>
                        <a id="twitter-footer" href="https://twitter.com/CodeWithKyrian"
                            class="text-zinc-500 hover:text-zinc-900 dark:hover:text-white dark:text-zinc-400">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                    ...
                    <li>
                        <a id="github-footer" href="https://github.com/CodeWithKyrian"
                            class="text-zinc-500 hover:text-zinc-900 dark:hover:text-white dark:text-zinc-400">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/kyrian-obikwelu/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3Bi8wfEgH2SRmS%2BUynt7uLpQ%3D%3D"
                            class="text-zinc-500 hover:text-zinc-900 dark:hover:text-white dark:text-zinc-400">
